...
export default function StockMatrixErrorPage({ error, reset }: ErrorPageProps) {
  return (
    <div className="flex min-h-screen items-center justify-center bg-[var(--background)] p-8">
      <Card className="max-w-md w-full">
        <CardContent className="p-6 text-center">
          ...
          <h2 className="text-lg font-semibold text-[var(--foreground)]">Failed to load stock matrix</h2>
